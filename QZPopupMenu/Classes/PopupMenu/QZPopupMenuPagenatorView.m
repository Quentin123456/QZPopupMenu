...
@implementation QZPopupMenuPagenatorView
...
+ (instancetype)leftPagenatorViewWithTarget:(id)target action:(SEL)action {
    ...
    return [[self alloc] initWithArrowDirection:QZPopupMenuPagenatorDirectionLeft target:target action:action];
    
}

+ (instancetype)rightPagenatorViewWithTarget:(id)target action:(SEL)action {
    
    return [[self alloc] initWithArrowDirection:QZPopupMenuPagenatorDirectionRight target:target action:action];
...
- (UIImage *)arrowImageWithSize:(CGSize)size direction:(QZPopupMenuPagenatorDirection)direction highlighted:(BOOL)highlighted {
...
- (CGMutablePathRef)arrowPathInRect:(CGRect)rect direction:(QZPopupMenuPagenatorDirection)direction {
    
    CGMutablePathRef path = CGPathCreateMutable();
    
    switch (direction) {
            case QZPopupMenuPagenatorDirectionLeft:
        {
            ...
            case QZPopupMenuPagenatorDirectionRight:
        {
